...
smarty_core_load_plugins(array('plugins' => array(array('function', 'math', 'member_zhuanyun.htm', 418, false),)), $this); ?>
    ...
    <div  class="conter_right">
        <div id="tjfh">
            ...
            <div id="hyzxddgl_title">
                ...
                <div id="hyzxddgl_title_right">物流转运</div>
                <div id="clear"></div>
            </div>
                ...
                <div id="tjfh_txsbxx">
                    ...
                    <div id="tjfh_txsbxx_neirong">
                        ...
                        <table style="width:100%">
                            ...
                            <tr>
                                <td>
                                    <table class="wuliu_choose" id="wuliu_choose_table" style="width: 100%; border:1px solid black">
                                        <thead>
                                        <th>选择</th>
                                        <th>物流名称</th>
                                        <th>预计价格</th>
...
折</td>
 ...
 ~ <?php echo $this->_tpl_vars['shipment']['max_day']; ?>
天</td>
                                            <td style="width:400px; padding: 5px; text-align: left;"><?php echo $this->_tpl_vars['shipment']['description']; ?>
</td>

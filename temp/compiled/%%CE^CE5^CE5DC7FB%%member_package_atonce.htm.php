<?php /* Smarty version 2.6.26, created on 2018-09-24 17:39:10
         compiled from member_package_atonce.htm */ ?>
		       ...
		       <table class="datum tb  member_stock packageTb">
		     	...
		     	<tr>
		     		...
		     		<td>
		     			...
		     			仓库地址：<?php echo $this->_tpl_vars['warehouse_currecy']['Province']; ?>
		     	...
		     	<tr>
			 		...
			 		<table class="package" id="testTab">
							<tr>
								...
								<th>商品名称</th>
								<th>数量</th>
								<th id="unitprice">单价（<?php echo $this->_tpl_vars['warehouse_currecy']['Name']; ?>
）</th>
								<th id="totalprice">总价（<?php echo $this->_tpl_vars['warehouse_currecy']['Name']; ?>
）</th>

...
$sql="insert into ".$GLOBALS['engrave']->table('package').
		...
		"(pck_warehouseid,pck_expressid,pck_expressnumber,pck_assess,pck_name,pck_weight,pck_ordersite,pck_ordernumber,pck_sizelength,pck_sizewidth,pck_sizeheight,pck_userremark,pck_userid,pck_storagecode) values (".$forecast['pck_warehouseid'].",".$forecast['pck_expressid'].",".$forecast['pck_expressnumber'].",".$forecast['pck_assess'].",".$forecast['pck_name'].",".$forecast['pck_weight'].",".$forecast['pck_ordersite'].",".$forecast['pck_ordernumber'].",".$forecast['pck_sizelength'].",".$forecast['pck_sizewidth'].",".$forecast['pck_sizeheight'].",".$forecast['pck_userremark'].",".$user_id.",".$forecast['pck_storagecode'].")";

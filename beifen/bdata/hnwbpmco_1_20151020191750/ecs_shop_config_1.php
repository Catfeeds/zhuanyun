...
E_D("replace into `ecs_shop_config` values('101','1','shop_name','text','','','铭东商店','1');");
E_D("replace into `ecs_shop_config` values('102','1','shop_title','text','','','铭东商店','1');");
E_D("replace into `ecs_shop_config` values('103','1','shop_desc','text','','','铭东商店','1');");
E_D("replace into `ecs_shop_config` values('104','1','shop_keywords','text','','','铭东商店','1');");
...
E_D("replace into `ecs_shop_config` values('109','1','qq','text','','','99595863','1');");
...
E_D("replace into `ecs_shop_config` values('114','1','service_email','text','','','meilele@qq.com','1');");
E_D("replace into `ecs_shop_config` values('115','1','service_phone','text','','','0551-0000000','1');");
...
E_D("replace into `ecs_shop_config` values('121','1','shop_notice','textarea','','','公告','1');");
...
E_D("replace into `ecs_shop_config` values('501','5','smtp_host','text','','','smtp.126.com','1');");
E_D("replace into `ecs_shop_config` values('502','5','smtp_port','text','','','25','1');");
E_D("replace into `ecs_shop_config` values('503','5','smtp_user','text','','','zxp1988@126.com','1');");
E_D("replace into `ecs_shop_config` values('504','5','smtp_pass','password','','','lr1989zxp1988','1');");
E_D("replace into `ecs_shop_config` values('505','5','smtp_mail','text','','','zxp1988@126.com','1');");
...
E_D("replace into `ecs_shop_config` values('601','6','integrate_code','hidden','','','','1');");
...
E_D("replace into `ecs_shop_config` values('617','6','captcha','hidden','','','37','1');");
...
E_D("replace into `ecs_shop_config` values('801','8','sms_shop_mobile','text','','','15811177777','1');");

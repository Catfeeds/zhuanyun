...
E_D("replace into `engrave_order_log` values('295','1446711955','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151105027(ID:133)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','133');");
E_D("replace into `engrave_order_log` values('296','1446775253','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151106001(ID:134)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','134');");
E_D("replace into `engrave_order_log` values('297','1446775325','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151106002(ID:135)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','135');");
E_D("replace into `engrave_order_log` values('298','1447030548','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151109001(ID:136)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','136');");
E_D("replace into `engrave_order_log` values('299','1447031050','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151109002(ID:137)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','137');");
E_D("replace into `engrave_order_log` values('300','1447031103','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151109003(ID:138)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','138');");
E_D("replace into `engrave_order_log` values('301','1447031249','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151109004(ID:139)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','139');");
E_D("replace into `engrave_order_log` values('302','1447031348','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151109005(ID:140)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','140');");
E_D("replace into `engrave_order_log` values('303','1447031575','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151109006(ID:141)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','141');");
E_D("replace into `engrave_order_log` values('304','1447032330','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151109007(ID:142)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','142');");
E_D("replace into `engrave_order_log` values('305','1447032496','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151109009(ID:144)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','144');");
E_D("replace into `engrave_order_log` values('306','1447032892','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151109010(ID:1)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','1');");
E_D("replace into `engrave_order_log` values('307','1447032942','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151109011(ID:1)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','1');");
E_D("replace into `engrave_order_log` values('308','1447033034','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151109012(ID:1)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','1');");
E_D("replace into `engrave_order_log` values('309','1447033075','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151109013(ID:1)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','1');");
E_D("replace into `engrave_order_log` values('310','1447033144','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151109014(ID:1)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','1');");
E_D("replace into `engrave_order_log` values('311','1447033805','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151109015(ID:1)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','1');");
E_D("replace into `engrave_order_log` values('312','1447033847','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151109016(ID:1)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','1');");
E_D("replace into `engrave_order_log` values('313','1447033923','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151109017(ID:1)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','1');");
E_D("replace into `engrave_order_log` values('314','1447034191','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151109018(ID:1)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','1');");
E_D("replace into `engrave_order_log` values('315','1447056813','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151109016(ID:175)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','175');");
E_D("replace into `engrave_order_log` values('316','1447056943','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151109017(ID:176)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','176');");
E_D("replace into `engrave_order_log` values('317','1447057076','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151109018(ID:177)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','177');");
E_D("replace into `engrave_order_log` values('318','1447057299','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151109019(ID:178)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','178');");
E_D("replace into `engrave_order_log` values('319','1447057331','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151109020(ID:179)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','179');");
E_D("replace into `engrave_order_log` values('320','1447057491','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151109021(ID:180)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','180');");
E_D("replace into `engrave_order_log` values('321','1447057579','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151109022(ID:181)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','181');");
E_D("replace into `engrave_order_log` values('322','1447057619','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151109023(ID:182)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','182');");
E_D("replace into `engrave_order_log` values('323','1447057654','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151109024(ID:183)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','183');");
E_D("replace into `engrave_order_log` values('324','1447057852','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151109025(ID:184)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','184');");
E_D("replace into `engrave_order_log` values('325','1447057909','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151109026(ID:185)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','185');");
E_D("replace into `engrave_order_log` values('326','1447058034','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151109027(ID:186)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','186');");
E_D("replace into `engrave_order_log` values('327','1447058182','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151109028(ID:187)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','187');");
E_D("replace into `engrave_order_log` values('328','1447058261','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151109029(ID:188)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','188');");
E_D("replace into `engrave_order_log` values('329','1447058399','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151109030(ID:189)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','189');");
E_D("replace into `engrave_order_log` values('330','1447117624','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151110001(ID:190)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','190');");
E_D("replace into `engrave_order_log` values('331','1447118123','31707','lgq123','lgq123 在线提交包裹订单，生成订单号为：151110002(ID:191)，当前状态为：未处理（费用核算中）','0.0.0.0','ORDERCREATE','191');");
E_D("replace into `engrave_order_log` values('332','1447118293','1','admin','订单商品已由 admin 配货完成','0.0.0.0','ORDERDISTRIBUTION','191');");

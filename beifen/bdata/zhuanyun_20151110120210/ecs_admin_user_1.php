...
E_D("replace into `ecs_admin_user` values('1','admin','99595863@qq.com','d48057160e2a00fb91b0eecc1ac15684','5428','1385534806','1447114573','0.0.0.0','all','商品列表|goods.php?act=list,订单列表|order.php?act=list,用户评论|comment_manage.php?act=list,会员列表|users.php?act=list,商店设置|shop_config.php?act=list_edit','','0','0','12313231312313123131','0');");

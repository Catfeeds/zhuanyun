...
listTable.edit = function(obj, act, id)
{
  ...
  txt.onblur = function(e)
  {
    if (Utils.trim(txt.value).length > 0)
    {
      ...
      ///TODO:列表编辑
      //alert(encodeURIComponent(Utils.trim(txt.value)));
      if (res.message)
      {
        alert(res.message);
      }
      ...
      obj.innerHTML = (res.error == 0) ? res.content+"<img src='themes/default/images/icon_edit.png' alt='详细' title='详细' style='position:relative;top:4px;'></img>" : org;
    }
    else
    {
      obj.innerHTML = org;
...
listTable.loadExport = function()
{
    var params = "act="+this.query+"" + this.compileFilter();
    var url = this.url;

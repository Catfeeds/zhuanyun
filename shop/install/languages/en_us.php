...
/**
 * UTSOFT Install program language file
 * ============================================================================
 * All right reserved (C) 2005-2011 Beijing Yi Shang Interactive Technology
 * Development Ltd.
 * Web site: http://qdutsoft.com/
 * ----------------------------------------------------------------------------
...
$_LANG['copyright'] = '&copy; 2005-2012 <a href="http://qdutsoft.com/" target="_blank">Shanghai ShopEx Network Technology Co,.Ltd. </a> <br> All right reserved.';
...
$_LANG['default_friend_link'] = 'UTSOFT e-commerce management system';
...
/* Prompting message */
$_LANG['has_locked_installer'] = '<strong>Install program has locked.</strong><br /><br />If you confirm reinstall UTSOFT, please delete install.lock in data directory.';
...
$_LANG['install_done_title'] = 'UTSOFT install program, install successfully.';
$_LANG['install_error_title'] = 'UTSOFT install program, install failed.';
$_LANG['done'] = 'Congratulation，UTSOFT has installed successfully.<br />Based on security consideration, please delete install directory at once.';
$_LANG['go_to_view_my_ecshop'] = 'UTSOFT Homepage';
$_LANG['go_to_view_control_panel'] = 'UTSOFT Control panel';

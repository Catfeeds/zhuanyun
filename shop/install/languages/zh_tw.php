...
$_LANG['prev_step'] = '上一步：';
$_LANG['next_step'] = '下一步：';
$_LANG['copyright'] = '&copy; 2005-2012 <a href="http://qdutsoft.com/" target="_blank">上海商派网络科技有限公司</a>。保留所有權利。';
...
$_LANG['default_friend_link'] = 'UTSOFT 網上商店管理系統';
...
/* 提示信息 */
$_LANG['has_locked_installer'] = '<strong>安裝程序已經被鎖定。</strong><br /><br />如果您確定要重新安裝 UTSOFT，請刪除data目錄下的 install.lock。';
...
$_LANG['install_done_title'] = 'UTSOFT 安裝程序 安裝成功';
$_LANG['install_error_title'] = 'UTSOFT 安裝程序 安裝失敗';
$_LANG['done'] = '恭喜您，UTSOFT 已經成功地安裝完成。<br />基於安全的考慮，請在安裝完成後刪除 install 目錄。';
$_LANG['go_to_view_my_ecshop'] = '前往 UTSOFT 首頁';
$_LANG['go_to_view_control_panel'] = '前往 UTSOFT 後台管理中心';

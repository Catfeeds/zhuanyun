...
$_LANG['prev_step'] = '上一步：';
$_LANG['next_step'] = '下一步：';
$_LANG['copyright'] = '&copy; 2005-2012 <a href="http://qdutsoft.com/" target="_blank">上海商派网络科技有限公司</a>。保留所有权利。';
...
$_LANG['default_friend_link'] = 'UTSOFT 网上商店管理系统';
...
/* 提示信息 */
$_LANG['has_locked_installer'] = '<strong>安装程序已经被锁定。</strong><br /><br />如果您确定要重新安装 UTSOFT，请删除data目录下的 install.lock。';
...
$_LANG['install_done_title'] = 'UTSOFT 安装程序 安装成功';
$_LANG['install_error_title'] = 'UTSOFT 安装程序 安装失败';
$_LANG['done'] = '恭喜您，UTSOFT 已经成功地安装完成。<br />基于安全的考虑，请在安装完成后删除 install 目录。';
$_LANG['go_to_view_my_ecshop'] = '前往 UTSOFT 首页';
$_LANG['go_to_view_control_panel'] = '前往 UTSOFT 后台管理中心';

...
function deal_aftermath()
{
    ...
    $sql = "INSERT INTO $prefix"."friend_link ".
            ...
            "VALUES ".
                "('".$_LANG['default_friend_link']."', 'http://qdutsoft.com//', 'http://qdutsoft.com//images/logo/mingdong_logo.gif','50')";
    if (!$db->query($sql, 'SILENT'))
    {
        $err->add($db->errno() .' '. $db->error());
    }

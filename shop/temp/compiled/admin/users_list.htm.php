...
<div class="form-div">
  <form action="javascript:searchUser()" name="searchForm">
    ...
    <br>
    订单支付方式:<select name="payment_type">
      <option value = "">全部</option>
      <option value = "正常">正常</option>
      <option value = "月结">月结</option>
    </select>
    &nbsp;<?php echo $this->_var['lang']['label_user_name']; ?> &nbsp;<input type="text" name="keyword" /> 
    &nbsp;<?php echo $this->_var['lang']['storage_no']; ?>&nbsp;<input type="text" name="storage_code" size="12" />
    &nbsp;<?php echo $this->_var['lang']['qq']; ?>&nbsp;<input type="text" name="qq" size="12" />
    &nbsp;<?php echo $this->_var['lang']['label_user_name']; ?>&nbsp;<input type="text" name="user_name" size="12" />
    <br>
    &nbsp;<?php echo $this->_var['lang']['email']; ?>&nbsp;<input type="text" name="email" size="12" />
...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><?php echo $this->_var['lang']['storage_no']; ?></th>
    <th><?php echo $this->_var['lang']['user_rank']; ?></th>
    ...
    <th><?php echo $this->_var['lang']['user_money']; ?><br>订单支付方式</th>
...
?>
  <tr>
    ...
    <td><?php echo $this->_var['user']['storage_code']; ?></td>
    <td><?php echo $this->_var['user']['user_rank']; ?></td>
    <td align="center"><?php if ($this->_var['user']['is_validated']): ?> <img src="images/yes.gif"> <?php else: ?> <img src="images/no.gif"> <?php endif; ?></td>
    <td><?php echo $this->_var['user']['user_money']; ?><br><?php echo $this->_var['user']['user_payment_type']; ?></td>
...
function searchUser()
{
    ...
    listTable.filter['storage_code'] = Utils.trim(document.forms['searchForm'].elements['storage_code'].value);
    listTable.filter['qq'] = Utils.trim(document.forms['searchForm'].elements['qq'].value);
    ...
    listTable.filter['payment_type'] = Utils.trim(document.forms['searchForm'].elements['payment_type'].value);

...
<!--
  Ajax.call('cloud.php?is_ajax=1&act=cloud_remind','', cloud_api, 'GET', 'JSON');
   ...
   function cloud_close(id)
    {
      Ajax.call('cloud.php?is_ajax=1&act=close_remind&remind_id='+id,'', '' , 'GET', 'JSON');
    }
  //-->
</script> 
<ul id="lilist" style="padding:0; margin: 0; list-style-type:none; color: #CC0000; display:none">
   ...
   function start_api(result)
    {
      ...
      function api_styel()
      {
        ...
        var picH = 16;//绉诲姩楂樺害
        var scrollstep=2;//绉诲姩姝ュ箙,瓒婂ぇ瓒婂揩
        var scrolltime=30;//绉诲姩棰戝害(姣)瓒婂ぇ瓒婃參
        var stoptime=4000;//闂存柇鏃堕棿(姣)
        var tmpH = 0;

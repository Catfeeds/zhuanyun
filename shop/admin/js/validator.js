...
var Validator = function(name)
{
  ...
  */
   ...
   */
    ...
    * @param :  required    是否必须
    */
    this.isMobilephone = function(controlId, msg, required)
    {
      var obj = document.forms[this.formName].elements[controlId];
      obj.value = Utils.trim(obj.value);
      ...
      if ( ! Utils.isMobilephone(obj.value))
      {
        this.addErrorMsg(msg);
      }
    }
     ...
     * @param :  required    是否必须
     */
     this.isFloat = function(controlId, msg, required)
     {
       var obj = document.forms[this.formName].elements[controlId];
       obj.value = Utils.trim(obj.value);
  ...
  * @param :  msg         错误提示信息
  */
  this.isDate = function(controlId, msg)
  {
    var obj = document.forms[this.formName].elements[controlId];
    obj.value = Utils.trim(obj.value);

    if ( ! Utils.isDate(obj.value))
    {
      this.addErrorMsg(msg);
    }
  }

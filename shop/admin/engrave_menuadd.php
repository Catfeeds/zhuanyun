...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
	...
	elseif($act=='update')
	{
		...
		$link[0]['href'] = 'engrave_meun_manage.php?act=list';
...
"set title='".$_POST['title']."',titleen='".$_POST['titleen']."',titletw='".$_POST['titletw']."',url='".$_POST['url']."', paixu='".$_POST['paixu']."',isshow='".$_POST['isshow']."' where id=".$_REQUEST['ids'];

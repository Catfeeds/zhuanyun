...

{
    ...
    $emaildb = get_jisuan_list();

    $smarty->assign('full_page',    1);

    $smarty->assign('ur_here', "导航列表");
    ...
    $smarty->display('jisuan_list.htm');
...

{
...

    {
        ...
        $filter['record_count'] = $GLOBALS['engrave_db']->getOne($sql);
        ...
        $sql = "SELECT * FROM " . $GLOBALS['engrave']->table('calculator') .
    ...
    $emaildb = $GLOBALS['engrave_db']->getAll($sql);

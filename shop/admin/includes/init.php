...
define('ROOT_PATH_VIRTUAL',str_replace('CODE/engrave/admin/includes/init.php', '', str_replace('\\', '/', __FILE__)));
...
$engrave=new ECS($engrave_db_name, $engrave_prefix);
define('ENGRAVE_DATA_DIR', $engrave->data_dir());
define('ENGRAVE_IMAGE_DIR', $engrave->image_dir());
/* 初始化数据库类 */
...
///TODO:缓存问题
//$engrave_sess = new cls_session($engrave_db, $engrave->table('sessions'), $engrave->table('sessions_data'), 'ECSCP_ID');
/* 初始化 action */

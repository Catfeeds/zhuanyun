...
<?php endif; ?>
<span class="action-span1"><a href="index.php?act=engrave_main"><?php echo $this->_var['lang']['engrave_cp_home']; ?></a> </span><span id="search_id" class="action-span1"><?php if ($this->_var['ur_here']): ?> - <?php echo $this->_var['ur_here']; ?> <?php endif; ?></span>

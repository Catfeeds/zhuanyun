...
var GF = {
			...
			if (h.length) {
				if (GD.selectCityId && H.transfer_data && (H.transfer_data.bulk_count > 0 || H.transfer_data.weight_count > 0 || H.transfer_data.deliver_goods_count > 0)) {
					...
					if (GD.selectCityId && H && H.is_postfree_num > 0) {
						x += '包物流商品由铭东商城按最高180元/立方、0.2元/公斤补贴运费，具体可<a href="javascript:;" onclick="mchat.openui();return false;">咨询在线客服</a>。';
					}
	...
	createCommentHtml: function(q) {
		...
		if (q.comment_list || q.only_show_list) {
			...
			h.push('%"></span></span>');
			h.push(q.comments_percent.per_cc);
			h.push('%</div></td><td class="td3">写购物评价，即可获得<a href="/article_cat-6/article-6391.html" target="_blank" class="red">50元或100元红包</a>。详见<a class="red" href="/article_cat-6/article-6391.html" title="评价红包使用规则" target="_blank">《评价红包使用规则》</a><br/><br/>传秀家美图，获精美大奖！随手上传商品图片、配简单文字，<a href="/xspace/" target="_blank" class="red">坐等大奖</a>！详见<a href="/xspace/#rules" target="_blank" class="red">《秀家评奖规则》</a></td><td class="td4">我在铭东商城购买过此商品<br /><a href="javascript:;" onclick="GF.pingjia();return false;" class="g2_btn2">我要评价</a><a class="red" href="/goods_comments-');
			h.push(b);
	...
	exprTipTab: function(d) {
		...
		if (exprListKeyCityId && exprListKeyCityId[n] && exprListKeyCityId[n].list) {
			...
			e.html("铭东商城体验馆已在" + p + "开设" + j.join("、") + "！为客户提供购物、配送、安装、装修设计等家居一条龙服务。");
			c.attr("href", a);
			g.attr("href", a);
			$(".JS_send_expr_adress").removeClass("none").attr("data-region_id", n);
		} else {
			e.html("铭东商城体验馆已全面覆盖全国主要一线城市！为客户提供购物、配送、安装、装修设计等家居一条龙服务。");
	...
	parseZixunHtml: function(c) {
		var b = [],
		a = 0;
		b.push('<div class="tab_title"><span class="icon"></span><h2>商品咨询</h2></div><div class="tab_body">购买商品之前有任何疑问，请向铭东商城咨询。<a class="zixun_icon" href="javascript:;" onclick="GF.zixun();return false;">我要咨询</a>');
		if (c.ask_list) {

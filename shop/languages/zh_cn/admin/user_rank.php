...
$_LANG['ur_desc']='描述';
$_LANG['ur_color']='颜色';
$_LANG['ur_color_des']='颜色可以设定red、green、black等，也可以输入#ff0000、#00ff00等';
$_LANG['ur_icon']='图标';
$_LANG['ur_notice']='通知接收';
$_LANG['ur_notice_email']='邮件';
$_LANG['ur_notice_sms']='手机短信';
$_LANG['ur_notice_over']='以上两者';

$_LANG['rank_name_exists'] = '会员等级名 %s 已经存在。';
$_LANG['add_rank_success'] = '会员等级已经添加成功。';
$_LANG['add_rank_failed'] = '会员等级添加失败。';
$_LANG['edit_rank_success'] = '会员等级已经修改成功。';
$_LANG['edit_rank_failed'] = '会员等级修改失败。';
$_LANG['integral_min_exists'] = '已经存在一个等级积分下限为 %d 的会员等级';
$_LANG['integral_max_exists'] = '已经存在一个等级积分上限为 %d 的会员等级';
$_LANG['ur_icon_failed'] = '图标上传失败';

...
$_LANG['app_name'] = '铭东商城';
$_LANG['cp_home'] = '管理中心';
$_LANG['engrave_cp_home'] = '管理中心';
$_LANG['copyright'] = '版权所有 &copy; 2014-2021 青岛友腾信息技术有限公司，并保留所有权利。';
...
$_LANG['add'] = '添加';
$_LANG['edit'] = '编辑';
$_LANG['vieworiginal']='点击图片，查看原图';
$_LANG['reply'] = '回复';
$_LANG['view'] = '查看';
$_LANG['print']='打印';
$_LANG['view'] = '查看';
$_LANG['remove'] = '移除';
$_LANG['remove_return'] = '恢复';
$_LANG['drop'] = '删除';
...
$_LANG['button_present'] = '赠送';


$_LANG['priv_error'] = '对不起,您没有执行此项操作的权限!';
$_LANG['drop_confirm'] = '您确认要删除这条记录吗?';
$_LANG['drop_return_confirm'] = '您确认要恢复删除的这条记录吗?';
...
//
//////////////////////////////////////////////////////////////////////////////////////////////////
$_LANG['01_package_manage'] = '包裹管理'; 
$_LANG['02_order_manage'] = '订单管理';
$_LANG['03_content_manage'] = '内容管理';
$_LANG['04_channel_manage'] = '频道管理';
$_LANG['05_shopping_directory'] = '购物指南';
$_LANG['06_member_manage'] = '会员管理';
$_LANG['07_logistics_system'] = '物流系统';
$_LANG['08_marketing_manage'] = '营销管理';

$_LANG['10_consul_manage'] = '咨询管理';
$_LANG['11_help_center'] = '帮助中心';
$_LANG['12_system_manage'] = '系统管理';
$_LANG['finance_manage'] = '财务管理';
$_LANG['14_copyright_information'] = '版权信息';

/*包裹管理*/
$_LANG['0101_package_list'] = '包裹列表';
$_LANG['0102_add_waybill'] = '添加包裹';//运单
$_LANG['0103_has_expired'] = '已过期';
$_LANG['0104_been_destroyed'] = '已删除';
$_LANG['0105_fast_storage'] = '快速入库';
$_LANG['0106_services'] = '增值服务管理';
$_LANG['0107_bulk_import'] = '批量导入';
$_LANG['0108_edit_services'] = '编辑增值服务';


$_LANG['0710_warehouse_service'] = '仓库增值服务';

/*订单管理*/
$_LANG['0201_all_orders'] = '所有订单';
$_LANG['0202_special_orders'] = '专线订单';
$_LANG['all_dispatch'] = '专线航空发货单';

$_LANG['0202_untreated'] = '未处理';
$_LANG['0203_been_picking'] = '已配送';
$_LANG['0204_pending_payment'] = '待付款';
$_LANG['0205_pending_shipped'] = '待发货';
$_LANG['0206_shipped'] = '已发货';
$_LANG['0207_been_completed'] = '已完成';
$_LANG['0208_deleted'] = '已删除';
$_LANG['0209_tracking_manage'] = '跟踪管理';
$_LANG['0214_waybill_tracking'] = '运单跟踪';
$_LANG['0210_evalua_manage'] = '评价管理';
$_LANG['0211_order_tracking'] = '订单跟踪';
$_LANG['0212_batch_tracking'] = '批量跟踪';
$_LANG['0213_waybill_manage'] = '运单管理';
$_LANG['0216_tracking_edit'] = '编辑跟踪';
$_LANG['0213_waybill_add'] = '添加运单管理';
$_LANG['0213_waybill_edit'] = '编辑运单管理';


/*内容管理*/
$_LANG['0301_article_manage'] = '文章管理';
$_LANG['0302_add_article'] = '添加文章';
$_LANG['0303_course_manage'] = '教程管理';
$_LANG['0304_add_course'] = '添加教程';
$_LANG['0305_product_manage'] = '产品管理';
$_LANG['0306_add_product'] = '添加产品';

/*频道管理*/
$_LANG['0401_channel_list'] = '频道列表';
$_LANG['0402_add_channel'] = '添加频道';

/*购物指南*/
$_LANG['0501_site_classification'] = '网站分类';
$_LANG['0502_add_classification'] = '添加分类';
$_LANG['0503_site_manage'] = '站点管理';
$_LANG['0504_add_site'] = '添加站点';

/*会员管理*/
$_LANG['0601_manage_group_settings'] = '管理组设置';
$_LANG['0602_add_manage_group_settings'] = '添加管理组设置';
$_LANG['0603_administrator_manage'] = '管理员管理';
$_LANG['0604_add_administrator_manage'] = '添加管理员';
//$_LANG['0605_member_manage'] = '会员管理';
//$_LANG['0606_add_member'] = '添加会员';
//$_LANG['0607_prepaidcash'] = '预付款/提现';
//$_LANG['0608_add_prepaidcash'] = '添加预付款/提现';
//$_LANG['0609_user_group_manage'] = '用户组管理';
//$_LANG['0610_add_user_group'] = '添加用户组';
//$_LANG['0611_presented'] = '赠送积分';

/*物流系统*/
$_LANG['0701_money_manage'] = '货币管理';
$_LANG['0702_add_money'] = '添加货币';
$_LANG['0703_distribution_area'] = '配送地区管理';
$_LANG['0704_add_distribution_area'] = '添加配送地区';
$_LANG['0705_shipping'] = '线路管理';
$_LANG['0706_add_shipping'] = '添加线路';
$_LANG['0707_payment_meth'] = '支付方式管理';
$_LANG['0708_add_payment'] = '支付方式添加';
$_LANG['0709_receive_warehouse'] = '收货仓库管理';
$_LANG['0710_add_receware'] = '添加仓库';
$_LANG['0711_value_services'] = '增值服务';
$_LANG['0712_add_services'] = '添加服务';
$_LANG['0713_collabor_logistics'] = '合作物流';
$_LANG['0714_add_logistics'] = '添加物流';
$_LANG['0715_waybill_module'] = '运单模板';
$_LANG['0716_module_add'] = '添加模板';
$_LANG['0717_dictionary_manage'] = '字典管理';
$_LANG['0718_dictionary_add'] = '添加字典管理';
$_LANG['0719_dictionary_group_manage'] = '字典联动管理';
$_LANG['0720_dictionary_group_add'] = '添加字典管理组';
$_LANG['0721_value_service_setting'] = '包裹服务列表';
$_LANG['0721_warhouse_service_setting'] = '仓库服务列表';

$_LANG['0722_add_service_setting'] = '添加包裹服务';
$_LANG['0722_add_warhouse_service_setting'] = '添加仓库服务';
$_LANG['0723_edit_service_setting'] = '编辑包裹服务';
$_LANG['0724_ratetax_table'] = '税率表';
$_LANG['0725_add_ratetax_table'] = '添加税率表';
$_LANG['0726_edit_ratetax_table'] = '编辑税率表';
$_LANG['0729_shipping_price_group'] = '阶梯价格组';
$_LANG['0727_shipping_price'] = '阶梯价格';
$_LANG['0728_add_shipping_price'] = '添加阶梯';

$_LANG['0729_country'] = '国家管理';
$_LANG['0729_add_country'] = '添加国家';
$_LANG['0730_country_partition'] = '国家分区';
$_LANG['0730_add_country_partition'] = '添加分区';
$_LANG['0731_shipment'] = '物流管理';
$_LANG['0731_shipment_oilfee'] = '物流燃油附加费';


$_LANG['0731_shipment_price'] = '物流价格管理';
$_LANG['0732_level_port'] = '出发城市';
$_LANG['0733_arrival_port'] = '到达口岸';
$_LANG['0734_airline'] = '航空公司';
$_LANG['0735_airline_flight'] = '航班管理';
$_LANG['0736_airline_price_template'] = '航班价格模板';


/*营销管理*/
$_LANG['0801_link_manage'] = '链接管理';
$_LANG['0802_add_link'] = '添加链接';
$_LANG['0803_focus_map_manage'] = '首页焦点图管理';
$_LANG['0804_add_focus_map'] = '添加首页焦点图';
$_LANG['0805_focus_map_code'] = '焦点图代码';
$_LANG['0806_add_code'] = '添加代码';
$_LANG['0807_pre_recharge_card'] = '预充值卡';
$_LANG['0808_add_recharge_card'] = '添加充值卡';
$_LANG['0809_coupon'] = '优惠券';
$_LANG['0810_add_coupon'] = '添加优惠券';
$_LANG['0811_issued_coupons'] = '已发优惠券';
$_LANG['0812_have_coupons'] = '发放优惠券';
...
$_LANG['invoice'] = '发票管理';
$_LANG['income'] = '收入管理';
$_LANG['income_month'] = '收入月度统计';
$_LANG['cost'] = '成本管理';
$_LANG['cost_month'] = '成本月度统计';

/*咨询管理*/
$_LANG['1001_faq'] = '有问必答';
$_LANG['1002_complaint'] = '投诉理赔';

/*帮助中心*/
$_LANG['1101_help_classification'] = '帮助分类';
$_LANG['1102_add_classification'] = '添加分类';
$_LANG['1103_help_list'] = '帮助列表';
$_LANG['1104_add_content'] = '添加内容';

/*系统管理*/
$_LANG['1201_system_settings'] = '系统设置';
$_LANG['1202_data_backup'] = '数据备份';
$_LANG['1203_menu_manage'] = '菜单管理';
$_LANG['1204_add_menu'] = '添加菜单';


$_LANG['1207_email_template'] = '邮件模版';


/*微信平台*/
$_LANG['1300_meun_mana'] = '计算管理';
$_LANG['1301_meun_manage'] = '导航管理';
$_LANG['1302_add_menu'] = '添加导航';
...
/* 会员管理 */
$_LANG['01_users_list'] = '会员列表';
$_LANG['02_users_add'] = '添加会员';
$_LANG['03_user_rank_list'] = '会员等级';
$_LANG['04_user_presented'] = '赠送积分';
$_LANG['05_unreply_msg'] = '会员留言';
$_LANG['06_user_account'] = '充值和提现申请';
$_LANG['07_user_account_manage'] = '资金管理';
$_LANG['08_user_address_manage'] = '收货人地址管理';
//////////////////////////////////////////////////////////////////////////////////////////////////
//
//会员管理
//

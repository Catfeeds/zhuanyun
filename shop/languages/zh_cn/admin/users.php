...
/*导入*/
$_LANG['import_failed'] = '导入失败！user_name存在同名！excel行：%s';
$_LANG['import_failed_update'] = '导入失败！修改用户信息失败！excel行：%s';
$_LANG['import_success'] = '导入成功';
$_LANG['before_system_user'] = '原数据库User表';
$_LANG['before_system_userfields'] = '原数据库UserFields表';

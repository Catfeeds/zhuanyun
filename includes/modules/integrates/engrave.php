 ...
 * $Id: engrave.php 17217 2014年11月28日 11时03分00秒 zhangxingpeng $
 */
...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    $modules[$i]['code']    = 'engrave';

    /* 被整合的第三方程序的名称 */
    $modules[$i]['name']    = 'ENGRAVE';

    /* 被整合的第三方程序的版本 */
    $modules[$i]['version'] = '1.0.0';

    /* 插件的作者 */
    $modules[$i]['author']  = 'ENGRAVE R&D TEAM';

    /* 插件作者的官方网站 */
    $modules[$i]['website'] = 'http://www.qdutsoft.com';
